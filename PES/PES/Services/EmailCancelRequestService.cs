...
namespace PES.Services
{
    public class EmailCancelRequestService
    {
        ...
        //public bool SendEmail(string employeeEmail, string replayComment)
        //{
        //    MailMessage msje = new MailMessage();
        //    msje.From = new MailAddress(Globals.SMTPOutlookEmail);
        //    //msje.To.Add(ManagerEmail);
        //    msje.To.Add(employeeEmail);
        //    msje.Subject = " Cancel Request ";
        //    msje.Body = replayComment;
        ...
        public List<CancelRequestViewModel> GetDataRequest(int HeaderRequestId)
        {
            List<CancelRequestViewModel> dataRequests;
            CancelRequestViewModel data;
            ...
            try
            {
                ...
                using (OracleConnection db = dbContext.GetDBConnection())
                {
                    ...
                    using (OracleCommand command = new OracleCommand(query, db))
                    {
                        ...
                        dataRequests = new List<CancelRequestViewModel>();
                        while (reader.Read())
                        {
                            data = new CancelRequestViewModel();
                            data.ReasonCancellation = Convert.ToString(reader["REPLAY_COMMENT"]);
