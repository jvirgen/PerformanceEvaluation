--------------------------------------------------------
-- Archivo creado  - jueves-noviembre-24-2016   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table VACATIONS_HEADER_REQ
--------------------------------------------------------

  CREATE TABLE "PE"."VACATIONS_HEADER_REQ" 
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table VACATIONS_REQ_STATUS
--------------------------------------------------------

  CREATE TABLE "PE"."VACATIONS_REQ_STATUS" 
   (	"ID_REQ_STATUS" NUMBER(2,0), 
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table VACATIONS_SUBREQ
--------------------------------------------------------

  CREATE TABLE "PE"."VACATIONS_SUBREQ" 
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index HEADER_REQ_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "PE"."HEADER_REQ_PK" ON "PE"."VACATIONS_HEADER_REQ" ("ID_HEADER_REQ") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index LATENESS_ID_LATENESS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "PE"."LATENESS_ID_LATENESS_PK" ON "PE"."LATENESS" ("ID_LATENESS") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index LOCATION_ID_LOCATION_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "PE"."LOCATION_ID_LOCATION_PK" ON "PE"."LOCATION" ("ID_LOCATION") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PER_ID_PERIOD_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "PE"."PER_ID_PERIOD_PK" ON "PE"."PERIOD" ("ID_PERIOD") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index REQ_STATUS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "PE"."REQ_STATUS_PK" ON "PE"."VACATIONS_REQ_STATUS" ("ID_REQ_STATUS") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index SUBREQ_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "PE"."SUBREQ_PK" ON "PE"."VACATIONS_SUBREQ" ("ID_SUBREQ") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
