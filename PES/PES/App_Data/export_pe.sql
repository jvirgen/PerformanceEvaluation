...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "PE"."SEQCOMMENTS"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 ORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQDESCRIPTION
--------------------------------------------------------

   CREATE SEQUENCE  "PE"."SEQDESCRIPTION"  MINVALUE 1 MAXVALUE 36 INCREMENT BY 1 START WITH 37 CACHE 20 ORDER  CYCLE ;
--------------------------------------------------------
...
Insert into PE.DESCRIPTION (ID_DESCRIPTION,DESCRIPTION,ID_SUBTITLE) values (35,'Total  Competences',6);
...
Insert into PE.EMPLOYEE (ID_EMPLOYEE,FIRST_NAME,LAST_NAME,EMAIL,CUSTOMER,POSITION,ID_PROFILE,ID_MANAGER,HIRE_DATE,END_DATE,PROJECT) values (17,'Humberto','Francillard','h.francillard@4thsource.com','No Customer','Tech Lead',1,2,to_date('12-22-2015','MM-DD-YYYY'),null,null);
...
Insert into PE.EMPLOYEE (ID_EMPLOYEE,FIRST_NAME,LAST_NAME,EMAIL,CUSTOMER,POSITION,ID_PROFILE,ID_MANAGER,HIRE_DATE,END_DATE,PROJECT) values (58,'marareno','maca','mara.maca@4thsource.com','No Customer','.NET Developer',1,2,to_date('12-22-2015','MM-DD-YYYY'),null,null);
...
begin  
   if inserting then 
      if :NEW."ID_COMMENT" is null then 
         select SEQCOMMENTS.nextval into :NEW."ID_COMMENT" from dual; 
      end if; 
   end if; 
end;
